...
class preprocess:
    ...
    avg_delivery_time_area = joblib.load('avg_delivery_time_area.pkl')
    traffic_weather_impact = joblib.load('traffic_weather_impact.pkl')
    max_deliveries_per_vehicle = joblib.load('max_deliveries_per_vehicle.pkl')
